          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-gray-600 leading-relaxed mb-6">
                ...
                combustion. This is not a feature. It's a structural advantage.
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
            ...
            <div className="px-4">
              ...
              <p className="text-gray-600 leading-relaxed">
                ...
                controlled to ensure consistent quality and performance, meeting
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
              <svg
                className="w-12 h-12 text-electric-blue mb-4"
                fill="currentColor"
                viewBox="0 0 24 24"
              >
              ...
              <p className="text-lg leading-relaxed mb-6 italic">
                "Houston Anodes has been our trusted partner for over 15 years.
                Their commitment to quality and technical expertise is unmatched
                in the industry."
              </p>
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-white/70">
                    Engineering Director, Maritime Solutions Corp
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
              ...
              <p className="text-lg leading-relaxed mb-6 italic">
                "The performance and reliability of Houston Anodes products have
                significantly reduced our maintenance costs and extended the
                life of our offshore structures."
              </p>
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 bg-electric-blue/20 rounded-full flex items-center justify-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-white/70">
                    VP Operations, Global Energy Partners
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
              ...
              <p className="text-lg leading-relaxed mb-6 italic">
                "Houston Anodes delivers consistent quality and exceptional
                customer service. They understand our technical requirements and
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-white/70">
                    Lead Engineer, Infrastructure Solutions Inc
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
              ...
              <p className="text-lg leading-relaxed mb-6 italic">
                "We've used Houston Anodes across multiple international
                projects. Their global reach and local expertise make them an
                invaluable partner."
              </p>
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 bg-electric-blue/20 rounded-full flex items-center justify-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-white/70">
                    Project Manager, Pacific Marine Systems
                  </p>
                </div>
              </div>
            </div>
