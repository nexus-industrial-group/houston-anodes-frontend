...
export default function AnodesPage() {
  return (
    <div className="min-h-screen font-sans text-gray-800 bg-white">
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="flex-1 space-y-6">
            ...
            <h2 className="text-5xl md:text-6xl font-extrabold leading-tight">
              <span className="text-white">Aluminum &amp; Zinc.</span><br />
              <span className="text-primary-blue">Any Shape.</span><br />
              <span className="text-primary-blue">Any Specification.</span>
            </h2>
            <p className="text-text-on-dark text-base leading-relaxed max-w-md">
              Houston Anodes manufactures sacrificial anodes in aluminum and zinc
              alloys across six product families — from offshore platforms to vessel
              interiors. Every anode is custom-engineered, tested, and shipped with
            ...
            {[
              ...
              >
                <div className="flex items-baseline gap-1">
                  ...
                  {unit && <span className="text-lg font-semibold text-white/70">{unit}</span>}
                </div>
      ...
      <section id="aluminum-details" className="py-20 px-6 md:px-12 bg-gray-100">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
            ...
            <div className="rounded-2xl overflow-hidden shadow-lg bg-white flex flex-col">
              ...
              <div className="bg-navy px-8 py-7">
                <p className="text-xs font-bold uppercase tracking-[0.2em] text-accent/70 mb-2">Material Type 01</p>
                <h3 className="text-3xl font-extrabold text-white">Aluminum Alloy Anodes</h3>
              </div>

              {/* Description */}
              <div className="px-8 py-6 border-b border-gray-100">
                <p className="text-sm text-gray-600 leading-relaxed">
                  Cast in low-iron, high-purity aluminum alloys with traces of indium, zinc, and silicon.
                  Delivers a current output capacity over three times that of zinc — making it the preferred
                  choice for offshore and deepwater applications.
                </p>
              </div>
              ...
              <div className="px-8 py-6 border-t border-gray-100 space-y-3">
                <p className="text-[10px] font-bold uppercase tracking-[0.18em] text-primary-blue">Alloy Types Available</p>
                <div className="flex flex-wrap gap-2">
                  {['Type Galvalum III', 'Type Galvalum III DCW'].map((t) => (
                    <span key={t} className="inline-flex items-center gap-1.5 rounded-full border border-navy/20 bg-navy/5 px-3 py-1 text-xs font-semibold text-navy">
                      ✓ {t}
                    </span>
                  ))}
                </div>
              ...
              <div className="px-8 pb-6 space-y-2 border-t border-gray-100 pt-5">
                <p className="text-[10px] font-bold uppercase tracking-[0.18em] text-primary-blue">Chemical Composition Note</p>
                <p className="text-xs text-gray-500 leading-relaxed">
                  Exact chemical composition specified at time of order and verified against Material Test Reports
                  (MTRs) before production release. Chemical analysis performed on every heat using
                  Bruker–Quantron Magellan Q8 spectrometer.
                </p>
              </div>
                ...
                <div className="grid grid-cols-2 gap-x-4 gap-y-1.5 text-xs text-gray-600">
                  {[
                    ...
                    <React.Fragment key={i}>
                      <span className="flex items-start gap-1.5"><span className="mt-0.5 text-navy">•</span>{a}</span>
                      <span className="flex items-start gap-1.5"><span className="mt-0.5 text-navy">•</span>{b}</span>
                    </React.Fragment>
                  ))}
                </div>
              </div>
              ...
              <div className="px-8 pb-8 space-y-3 border-t border-gray-100 pt-5">
                <p className="text-[10px] font-bold uppercase tracking-[0.18em] text-primary-blue">Standards Compliance</p>
                <div className="flex flex-wrap gap-2">
                  {['NACE SP–0387', 'DNV RP B401', 'ISO 15589–2', 'NORSOK M–503'].map((s) => (
                    <span key={s} className="inline-flex items-center gap-1 rounded border border-gray-200 px-2.5 py-1 text-xs font-medium text-gray-700">
                      ✓ {s}
                    </span>
                  ))}
                </div>
            ...
            {/* ── ZINC ALLOY ANODES ── */}
            <div id="zinc-details" className="rounded-2xl overflow-hidden shadow-lg bg-white flex flex-col">
              {/* Header */}
              <div className="bg-primary-blue px-8 py-7">
                <p className="text-xs font-bold uppercase tracking-[0.2em] text-white/60 mb-2">Material Type 02</p>
                <h3 className="text-3xl font-extrabold text-white">Zinc Alloy Anodes</h3>
              </div>

              {/* Description */}
              <div className="px-8 py-6 border-b border-gray-100">
                <p className="text-sm text-gray-600 leading-relaxed">
                  Special High Grade Zinc at 99.99% purity. Preferred for deep, cold water and saline mud
                  applications where temperature does not exceed 50°C (120°F). Operates at 95% nominal
                ...
                <table className="w-full text-xs">
                  <thead>
                    <tr className="border-b border-gray-200">
                      ...
                      <th className="text-right py-2 font-bold uppercase tracking-wider text-gray-500">Specification</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-gray-100">
                    {[
                      ...
                      <tr key={el}>
                        ...
                        <td className="py-2 text-right text-gray-700 font-medium">{spec}</td>
                      </tr>
                    ))}
                    <tr className="bg-gray-50">
                      <td className="py-2 font-semibold text-gray-700">Zinc (Zn)</td>
              ...
              <div className="px-8 pb-6 space-y-3 border-t border-gray-100 pt-5">
                <p className="text-[10px] font-bold uppercase tracking-[0.18em] text-primary-blue">Electrochemical Properties</p>
                <div className="space-y-2 text-xs">
                  {[
                    ...
                    <div key={prop} className="flex justify-between border-b border-gray-100 pb-2">
              ...
              <div className="px-8 pb-8 space-y-3 border-t border-gray-100 pt-5">
                ...
                <div className="grid grid-cols-2 gap-x-4 gap-y-1.5 text-xs text-gray-600">
                  {[
                    ...
                    <React.Fragment key={i}>
                      <span className="flex items-start gap-1.5"><span className="mt-0.5 text-primary-blue">•</span>{a}</span>
                      <span className="flex items-start gap-1.5"><span className="mt-0.5 text-primary-blue">•</span>{b}</span>
                    </React.Fragment>
                  ))}
                </div>
              </div>
      ...
      <section className="bg-gray-50 py-20 px-6 md:px-12">
        <div className="max-w-6xl mx-auto space-y-14">
          ...
          <div className="flex flex-col lg:flex-row items-start gap-10">
            <div className="flex-1 space-y-4">
              ...
              <h2 className="text-4xl md:text-5xl font-extrabold text-gray-900 leading-tight">
                Six Product Families.<br />One Manufacturer.
              </h2>
            </div>
            <div className="flex-1 flex items-center">
              <p className="text-sm text-gray-500 leading-relaxed">
                All standard configurations are shown in our catalog. Houston Anodes also manufactures to exact
                customer specifications — any weight, any cross-section, any core configuration. Contact our
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            ...
            <div className="bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-200 flex flex-col">
              <div className="flex items-center justify-between px-5 pt-5">
                <span className="inline-block rounded bg-gray-900 px-2.5 py-1 text-[10px] font-bold uppercase tracking-widest text-white">Platforms</span>
              ...
              <div className="px-5 py-4 flex flex-col gap-4 flex-1">
                <div>
                  <h3 className="text-base font-extrabold text-gray-900 leading-snug">Platform & Structural Anodes</h3>
                  <p className="text-xs text-gray-500 leading-relaxed mt-1">
                    Cast in low-iron, high-purity aluminum alloys. Manufactured in a wide variety of configurations for new construction or retrofitting. Custom trapezoidal cross-sections available.
                  </p>
                </div>

                {/* Configurations */}
                <div className="space-y-1">
                  <p className="text-[9px] font-bold uppercase tracking-[0.15em] text-primary-blue">Configurations</p>
                  <ul className="space-y-0.5">
                    {['90° Core — Type A & B', '45° Core — Type A & B', 'Straight Core — Type A & B'].map(c => (
                      <li key={c} className="text-xs text-gray-600 flex items-start gap-1.5"><span className="text-primary-blue mt-0.5">–</span>{c}</li>
                    ))}
                  </ul>
                </div>
                ...
                <div className="grid grid-cols-2 gap-2 border-t border-gray-100 pt-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs font-semibold text-gray-700">2″ – 4″ SCH. 80</p>
                  </div>
                </div>

                {/* Key Applications */}
                <div>
                  <p className="text-[9px] font-bold uppercase tracking-[0.15em] text-gray-400 mb-1">Key Applications</p>
                  <p className="text-xs text-gray-600">Offshore platforms, structural members, new construction & retrofit</p>
                </div>
            ...
            <div className="bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-200 flex flex-col">
              <div className="flex items-center justify-between px-5 pt-5">
                <span className="inline-block rounded bg-gray-900 px-2.5 py-1 text-[10px] font-bold uppercase tracking-widest text-white">Bracelets</span>
                <span className="text-[9px] font-bold uppercase tracking-[0.15em] text-gray-400">Family 02</span>
              </div>
              <div className="relative w-full h-36 bg-gray-50 mt-3">
                <Image src="/images/anodes/pipeline.webp" alt="Bracelet Anode" fill className="object-contain p-5" />
              </div>
              <div className="px-5 py-4 flex flex-col gap-4 flex-1">
                <div>
                  <h3 className="text-base font-extrabold text-gray-900 leading-snug">Pipeline Bracelet Anodes</h3>
                  <p className="text-xs text-gray-500 leading-relaxed mt-1">
                    Manufactured in a wide variety of diameters using an extensive inventory of water-cooled molds. Available in square and tapered profiles with weld-on or bolt-on mounting.
                  </p>
                </div>
                ...
                <div className="space-y-1">
                  <p className="text-[9px] font-bold uppercase tracking-[0.15em] text-primary-blue">Configurations</p>
                  <ul className="space-y-0.5">
                    {['Square Weld-on', 'Square Bolt-on', 'Tapered Weld-on', 'Tapered Bolt-on'].map(c => (
                      <li key={c} className="text-xs text-gray-600 flex items-start gap-1.5"><span className="text-primary-blue mt-0.5">–</span>{c}</li>
                    ))}
                  </ul>
                </div>
                ...
                <div className="grid grid-cols-2 gap-2 border-t border-gray-100 pt-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs font-semibold text-gray-700">Any weight & diameter</p>
                  </div>
                </div>

                <div>
                  <p className="text-[9px] font-bold uppercase tracking-[0.15em] text-gray-400 mb-1">Key Applications</p>
                  <p className="text-xs text-gray-600">Subsea pipelines, Gulf of Mexico, offshore pipelines</p>
                </div>
            ...
            <div className="bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-200 flex flex-col">
              <div className="flex items-center justify-between px-5 pt-5">
                <span className="inline-block rounded bg-gray-900 px-2.5 py-1 text-[10px] font-bold uppercase tracking-widest text-white">Pier & Piling</span>
                <span className="text-[9px] font-bold uppercase tracking-[0.15em] text-gray-400">Family 03</span>
              </div>
              <div className="relative w-full h-36 bg-gray-50 mt-3">
                <Image src="/images/anodes/pier.webp" alt="Pier & Piling Anode" fill className="object-contain p-5" />
              </div>
              <div className="px-5 py-4 flex flex-col gap-4 flex-1">
                <div>
                  <h3 className="text-base font-extrabold text-gray-900 leading-snug">Pier, Piling & Ballast Anodes</h3>
                  <p className="text-xs text-gray-500 leading-relaxed mt-1">
                    Core length standard per size; holes may be drilled for bolt-on applications. Suitable for piers, jetties, and any piling or ballast application.
                  </p>
                </div>
                ...
                <div className="space-y-1">
                  <p className="text-[9px] font-bold uppercase tracking-[0.15em] text-primary-blue">Configurations</p>
                  <ul className="space-y-0.5">
                    {['Trapezoidal Flush Core', 'Stand-off Core — Type A & B', 'Rod Core', 'Rod Stand-off Core'].map(c => (
                      <li key={c} className="text-xs text-gray-600 flex items-start gap-1.5"><span className="text-primary-blue mt-0.5">–</span>{c}</li>
                    ))}
                  </ul>
                </div>
                ...
                <div className="grid grid-cols-2 gap-2 border-t border-gray-100 pt-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs font-semibold text-gray-700">Weld-on · Bolt-on</p>
                  </div>
                </div>

                <div>
                  <p className="text-[9px] font-bold uppercase tracking-[0.15em] text-gray-400 mb-1">Key Applications</p>
                  <p className="text-xs text-gray-600">Piers, jetties, pilings, ballast, harbor structures</p>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            ...
            <div className="bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-200 flex flex-col">
              <div className="flex items-center justify-between px-5 pt-5">
                <span className="inline-block rounded bg-gray-900 px-2.5 py-1 text-[10px] font-bold uppercase tracking-widest text-white">Tanks & Vessels</span>
                <span className="text-[9px] font-bold uppercase tracking-[0.15em] text-gray-400">Family 04</span>
              </div>
              <div className="relative w-full h-36 bg-gray-50 mt-3">
                <Image src="/images/anodes/tank.webp" alt="Tank & Vessel Anode" fill className="object-contain p-5" />
              </div>
              <div className="px-5 py-4 flex flex-col gap-4 flex-1">
                <div>
                  <h3 className="text-base font-extrabold text-gray-900 leading-snug">Tank & Vessel Anodes</h3>
                  <p className="text-xs text-gray-500 leading-relaxed mt-1">
                    Heater Treater anodes available with Red/Blue caps and nuts on request. Houston Anodes can cast for any tank bottom or vessel interior to exact specifications.
                  </p>
                </div>
                ...
                <div className="space-y-1">
                  <p className="text-[9px] font-bold uppercase tracking-[0.15em] text-primary-blue">Configurations</p>
                  <ul className="space-y-0.5">
                    {['Heater Treater', 'Heater Treater Eyebolt', 'Bowling Ball', 'Drum'].map(c => (
                      <li key={c} className="text-xs text-gray-600 flex items-start gap-1.5"><span className="text-primary-blue mt-0.5">–</span>{c}</li>
                    ))}
                  </ul>
                </div>
                ...
                <div className="grid grid-cols-2 gap-2 border-t border-gray-100 pt-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs font-semibold text-gray-700">¾″ Rod</p>
                  </div>
                </div>

                <div>
                  <p className="text-[9px] font-bold uppercase tracking-[0.15em] text-gray-400 mb-1">Key Applications</p>
                  <p className="text-xs text-gray-600">Tank bottoms, vessel interiors, heater treaters, pressure vessels</p>
                </div>
            ...
            <div className="bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-200 flex flex-col">
              <div className="flex items-center justify-between px-5 pt-5">
                <span className="inline-block rounded bg-gray-900 px-2.5 py-1 text-[10px] font-bold uppercase tracking-widest text-white">Hulls</span>
                <span className="text-[9px] font-bold uppercase tracking-[0.15em] text-gray-400">Family 05</span>
              </div>
              <div className="relative w-full h-36 bg-gray-50 mt-3">
                <Image src="/images/anodes/hull.webp" alt="Hull Anode" fill className="object-contain p-5" />
              </div>
              <div className="px-5 py-4 flex flex-col gap-4 flex-1">
                <div>
                  <h3 className="text-base font-extrabold text-gray-900 leading-snug">Hull Anodes</h3>
                  <p className="text-xs text-gray-500 leading-relaxed mt-1">
                    Manufactured in zinc alloy to MIL-A-18001-K specification. Operates at 95% nominal efficiency in seawater. Resists formation of hard, dense corrosion byproducts.
                  </p>
                </div>
                ...
                <div className="space-y-1">
                  <p className="text-[9px] font-bold uppercase tracking-[0.15em] text-primary-blue">Configurations</p>
                  <ul className="space-y-0.5">
                    {['Trapezoidal Hull', 'Trapezoidal Hull Cast-in Core', 'Hull Tapered', 'Tapered Trapezoidal', 'Teardrop'].map(c => (
                      <li key={c} className="text-xs text-gray-600 flex items-start gap-1.5"><span className="text-primary-blue mt-0.5">–</span>{c}</li>
                    ))}
                  </ul>
                </div>
                ...
                <div className="grid grid-cols-2 gap-2 border-t border-gray-100 pt-3">
                  <div>
                    <p className="text-[9px] font-bold uppercase tracking-[0.15em] text-gray-400 mb-0.5">Weight Range</p>
                    <p className="text-xs font-semibold text-gray-700">23 – 85 lbs (std)</p>
                  </div>
                  <div>
                    <p className="text-[9px] font-bold uppercase tracking-[0.15em] text-gray-400 mb-0.5">Mil-Spec</p>
                    <p className="text-xs font-semibold text-gray-700">MIL-A-18001-K</p>
                  </div>
                </div>

                <div>
                  <p className="text-[9px] font-bold uppercase tracking-[0.15em] text-gray-400 mb-1">Key Applications</p>
                  <p className="text-xs text-gray-600">Ship hulls, ballast tanks, sea chests, marine vessels</p>
                </div>
            ...
            <div className="rounded-2xl overflow-hidden shadow-sm border-2 border-primary-blue/30 bg-light-blue/30 flex flex-col">
              <div className="flex items-center justify-between px-5 pt-5">
                <span className="inline-block rounded bg-primary-blue px-2.5 py-1 text-[10px] font-bold uppercase tracking-widest text-white">Custom</span>
                <span className="text-[9px] font-bold uppercase tracking-[0.15em] text-primary-blue/50">Family 06</span>
              </div>
              <div className="relative w-full h-36 bg-primary-blue/5 mt-3">
                <Image src="/images/anodes/custom.webp" alt="Custom Anode" fill className="object-contain p-5" />
              </div>
              <div className="px-5 py-4 flex flex-col gap-4 flex-1">
                <div>
                  <h3 className="text-base font-extrabold text-gray-900 leading-snug">Custom Engineered Anodes</h3>
                  <p className="text-xs text-gray-500 leading-relaxed mt-1">
                    Houston Anodes manufactures anodes of almost any shape and size. With an extensive inventory of water-cooled molds and in-house mold manufacturing capability, no geometry is out of reach.
                  </p>
                </div>
                ...
                <div className="space-y-1">
                  <p className="text-[9px] font-bold uppercase tracking-[0.15em] text-primary-blue">Configurations</p>
                  <ul className="space-y-0.5">
                    {['Clamp', 'Mat', 'Link', 'Any geometry on request'].map(c => (
                      <li key={c} className="text-xs text-gray-600 flex items-start gap-1.5"><span className="text-primary-blue mt-0.5">–</span>{c}</li>
                    ))}
                  </ul>
                </div>
                ...
                <div className="grid grid-cols-2 gap-2 border-t border-primary-blue/10 pt-3">
                  <div>
                    <p className="text-[9px] font-bold uppercase tracking-[0.15em] text-gray-400 mb-0.5">Weight</p>
                    <p className="text-xs font-semibold text-gray-700">Any weight & size</p>
                  </div>
                  <div>
                    <p className="text-[9px] font-bold uppercase tracking-[0.15em] text-gray-400 mb-0.5">Geometry</p>
                    <p className="text-xs font-semibold text-gray-700">Provide drawing spec</p>
                  </div>
                </div>

                <div>
                  <p className="text-[9px] font-bold uppercase tracking-[0.15em] text-gray-400 mb-1">Key Applications</p>
                  <p className="text-xs text-gray-600">Mission-critical & specialized infrastructure projects</p>
                </div>
          ...
          <div className="space-y-8 pt-4">
            <div className="text-center space-y-3 max-w-xl mx-auto">
              <h3 className="text-3xl font-extrabold text-gray-900">Every Configuration at a Glance</h3>
              <p className="text-sm text-gray-500 leading-relaxed">
                Standard configurations are shown in our full product catalog. Every size and weight shown can
                also be manufactured in custom dimensions. Download the catalog or contact our team for full
                dimensional data.
              </p>
            </div>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="bg-navy text-white">
                    {['Product Family', 'Configurations', 'Weight / Size Range', 'Materials', 'Key Applications'].map(h => (
                      <th key={h} className="px-5 py-4 text-left text-[10px] font-bold uppercase tracking-widest">{h}</th>
                    ))}
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-100 bg-white">
                  {[
                    ...
                    },
                    {
                      ...
                      configs: ['Clamp', 'Mat', 'Link', 'Any geometry on request'],
                      range: 'Any weight & size',
                      materials: 'Al · Zn',
                      apps: 'Mission-critical & specialized infrastructure projects',
                    },
                  ].map(({ family, configs, range, materials, apps }, i) => (
                    <tr key={family} className={i % 2 === 1 ? 'bg-gray-50/60' : ''}>
                      <td className="px-5 py-4 font-semibold text-primary-blue align-top whitespace-nowrap">{family}</td>
                      <td className="px-5 py-4 align-top">
                        <ul className="space-y-0.5">
                          {configs.map(c => <li key={c} className="text-gray-600">{c}</li>)}
                        </ul>
                      </td>
                      <td className="px-5 py-4 align-top text-gray-700 whitespace-nowrap">{range}</td>
                      <td className="px-5 py-4 align-top text-gray-700 whitespace-nowrap">{materials}</td>
                      <td className="px-5 py-4 align-top text-gray-600">{apps}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
        ...
        <div className="max-w-6xl mx-auto px-6 md:px-12 py-24 flex flex-col lg:flex-row gap-16 items-stretch">
          ...
          <div className="flex-1 space-y-10 z-10">
            <div className="space-y-5">
              <p className="text-xs font-bold uppercase tracking-[0.2em] text-primary-blue">Custom Engineering</p>
              <h2 className="text-4xl md:text-5xl font-extrabold text-white leading-tight">
                If You Can Draw It,<br />We Can Cast It.
              </h2>
              <p className="text-sm text-text-on-dark/70 leading-relaxed max-w-sm">
                Houston Anodes can manufacture anodes of almost any shape and size required. With our extensive
                inventory of water-cooled molds — and the capability to manufacture our own molds in-house — we
                offer competitive prices on custom geometries that no standard catalog supplier can match.
              </p>
            </div>
              ...
              {[
                {
                  icon: (
                    <svg className="w-5 h-5 text-white/70" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M9 12h6m-6 4h6m-6-8h6M5 5h14a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2Z" />
                    </svg>
                  ),
                ...
                <div key={title} className="flex gap-4 rounded-xl border border-white/10 bg-navy-light/60 px-5 py-4">
          ...
          <div className="flex-1 flex items-center justify-center z-10">
            <div className="grid grid-cols-2 gap-8 w-full max-w-xl">
              {[
                ...
                <div key={img} className="rounded-2xl border border-white/10 overflow-hidden flex flex-col justify-center items-center bg-transparent shadow-xl">
      ...
      <section className="bg-gray-50 py-16 px-6 md:px-12">
        <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-8">
          <div className="space-y-2 max-w-lg">
            <h3 className="text-2xl font-extrabold text-gray-900">Request Our Full Product Catalog</h3>
            <p className="text-sm text-gray-500 leading-relaxed">
              Complete dimensional data, SKU tables, and weight specifications for all six product families.
